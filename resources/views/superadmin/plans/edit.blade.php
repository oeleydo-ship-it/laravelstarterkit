        ...
        <div class="col-lg-8">
            <div class="card stat-card">
                <div class="card-body p-4">
                    <h5 class="fw-bold mb-4">Edit Plan: {{ $plan->name }}</h5>
                    ...
                    <form method="POST" action="{{ route('superadmin.plans.update', $plan) }}">
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('key') is-invalid @enderror" id="key"
                                    name="key" value="{{ old('key', $plan->key) }}" required>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01"
                                    ...
                                    name="price_monthly" value="{{ old('price_monthly', $plan->price_monthly) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01"
                                    class="form-control @error('price_yearly') is-invalid @enderror" id="price_yearly"
                                    name="price_yearly" value="{{ old('price_yearly', $plan->price_yearly) }}" required>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                <label for="stripe_price_id_monthly" class="form-label fw-medium">Stripe Monthly Price
                                    ID</label>
                                <input type="text"
                                    class="form-control font-monospace @error('stripe_price_id_monthly') is-invalid @enderror"
                                    id="stripe_price_id_monthly" name="stripe_price_id_monthly"
                                    value="{{ old('stripe_price_id_monthly', $plan->stripe_price_id_monthly) }}"
                                    placeholder="price_...">
                                @error('stripe_price_id_monthly') <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                <label for="stripe_price_id_yearly" class="form-label fw-medium">Stripe Yearly Price
                                    ID</label>
                                <input type="text"
                                    class="form-control font-monospace @error('stripe_price_id_yearly') is-invalid @enderror"
                                    id="stripe_price_id_yearly" name="stripe_price_id_yearly"
                                    value="{{ old('stripe_price_id_yearly', $plan->stripe_price_id_yearly) }}"
                                    placeholder="price_...">
                                @error('stripe_price_id_yearly') <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('max_users') is-invalid @enderror"
                                    ...
                                    value="{{ old('max_users', $plan->getLimit('max_users', 5)) }}" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('max_modules') is-invalid @enderror"
                                    id="max_modules" name="max_modules"
                                    value="{{ old('max_modules', $plan->getLimit('max_modules', 3)) }}" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('storage_limit') is-invalid @enderror"
                                    ...
                                    value="{{ old('storage_limit', $plan->getLimit('storage_limit', 500)) }}" required>
